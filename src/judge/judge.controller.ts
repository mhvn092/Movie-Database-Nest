import { Body, Controller, Delete, Get, Param, Patch, Post, Put, Request, UseFilters, UseGuards, ValidationPipe } from '@nestjs/common';
import { ApiBadRequestResponse, ApiBearerAuth, ApiBody, ApiNotFoundResponse, ApiOperation, ApiTags, ApiUnauthorizedResponse } from '@nestjs/swagger';
import { AuthService } from '../auth/auth.service';
import { Role } from '../common/decorator/role.decorator';
import { UnauthorizedFilter } from '../common/filter/unauthorized-filter.filter';
import { JwtGuard } from '../common/guard/jwt.guard';
import { LocalAuthGuard } from '../common/guard/Local-guard.guard';
